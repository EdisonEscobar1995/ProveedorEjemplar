...
function TableListQuestions(props) {
  const {
    level,
    parentId,
    componentList,
                  ...
                  <Column
                    ...
                    render={(text, record) => (
                      <div>
                        ...
                        {
                          withAdd && (
                            <Tooltip title={<FormattedMessage id="Button.addQuetion" />}>
                              <Button
                                shape="circle"
                                icon="plus"
                                onClick={() => componentList[level].onRowClick(record)}
                              />
                            </Tooltip>
                          )
                        }
...
export default TableListQuestions;
