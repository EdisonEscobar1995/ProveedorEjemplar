const messages = {
  ...
  'Supplier.contactNutresaGroup.name': 'Contacto en Grupo Nutresa (Contacto Comercial y/o Negociador)',
  'Supplier.contactNutresaGroup.email': 'E-mail de la persona contacto en Grupo Nutresa',
  'Supplier.contactNutresaGroup.phone': 'Teléfono de la persona contacto en Grupo Nutresa',
  ...
  'Button.save': 'Guardar',
  'Button.add': 'Agregar',
  'Button.addQuetion': 'Agregar pregunta',
