const messages = {
  ...
  'Supplier.surveySuccess': 'Survey sent successfully',
  ...
  'Validation.supplier': 'There is no survey for the type of supply and company size selected',
